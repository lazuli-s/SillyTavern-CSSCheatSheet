        ...
        items: [
            {
                ...
                html: `<div class="options-content compact-context-menu" role="listbox" aria-multiselectable="true" style="width:160px;font-size:var(--mainFontSize);border-radius:6px"><button type="button" role="option" aria-selected="true" class="compact-context-option compact-context-option-selected"><i class="fa-solid fa-square-check compact-context-check"></i><i class="fa-solid fa-star compact-context-icon"></i><span>Action one</span></button><button type="button" role="option" aria-selected="false" class="compact-context-option"><i class="fa-regular fa-square compact-context-check"></i><i class="fa-solid fa-bookmark compact-context-icon"></i><span>Action two</span></button><button type="button" role="option" aria-selected="false" class="compact-context-option"><i class="fa-regular fa-square compact-context-check"></i><i class="fa-solid fa-bell compact-context-icon"></i><span>Action three</span></button><button type="button" role="option" aria-selected="true" class="compact-context-option compact-context-option-selected"><i class="fa-solid fa-square-check compact-context-check"></i><i class="fa-solid fa-trash-can compact-context-icon"></i><span>Remove</span></button></div>`,
                css: `.compact-context-menu {\n    display: flex;\n    flex-direction: column;\n    overflow: hidden;\n    border: 1px solid var(--SmartThemeBorderColor);\n    border-radius: 6px;\n    background-color: var(--SmartThemeBlurTintColor);\n    backdrop-filter: blur(var(--SmartThemeBlurStrength));\n    -webkit-backdrop-filter: blur(var(--SmartThemeBlurStrength));\n}\n\n.compact-context-menu .compact-context-option {\n    color: var(--SmartThemeBodyColor);\n    padding: 3px 6px;\n    text-decoration: none;\n    display: flex;\n    column-gap: 6px;\n    cursor: pointer;\n    align-items: center;\n    opacity: 0.5;\n    transition: opacity var(--animation-duration), background-color var(--animation-duration);\n    border: 0;\n    background: transparent;\n    width: 100%;\n    font: inherit;\n    text-align: left;\n}\n\n.compact-context-menu .compact-context-option:hover,\n.compact-context-menu .compact-context-option:focus-visible,\n.compact-context-menu .compact-context-option.compact-context-option-selected {\n    opacity: 1;\n}\n\n.compact-context-menu .compact-context-option:focus-visible {\n    outline: none;\n    background-color: color-mix(in srgb, var(--SmartThemeBodyColor) 10%, transparent);\n}\n\n.compact-context-menu i {\n    width: 14px;\n    height: 14px;\n    font-size: calc(var(--mainFontSize) * 0.9);\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    pointer-events: none;\n    flex-shrink: 0;\n}\n\n.compact-context-menu .compact-context-check {\n    color: var(--SmartThemeEmColor);\n}\n\n.compact-context-menu .compact-context-option.compact-context-option-selected .compact-context-check {\n    color: var(--SmartThemeQuoteColor);\n}`,
            },
        ],
    },
    {
        ...
        items: [
            {
                ...
                css: `.stwid--visibilityChip {\n    display: inline-flex;\n    align-items: center;\n    gap: 0.6em;\n    border: 1px solid var(--SmartThemeBorderColor);\n    border-radius: 999px;\n    padding: 0.25em 0.7em;\n    font-size: 0.8em;\n    background-color: color-mix(in srgb, var(--SmartThemeBlurTintColor) 85%, black 10%);\n}\n\n.stwid--visibilityChip .stwid--icon {\n    color: var(--SmartThemeQuoteColor);\n}`,
            },
            {
                name: 'Filter Chip',
                html: `<div style="display:inline-flex;align-items:center;gap:0.25em;border:1px solid var(--SmartThemeBorderColor);border-radius:4px;padding:0.1em 0.35em;font-size:0.85em;background:color-mix(in srgb,var(--SmartThemeBlurTintColor) 85%,black 10%)"><span>Position:</span><strong>0</strong><button style="background:none;border:none;padding:0 0.1em;cursor:pointer;color:var(--SmartThemeQuoteColor);line-height:1;font-size:1em">×</button></div>`,
                css: `.stwid--filterChip {\n    display: inline-flex;\n    align-items: center;\n    gap: 0.25em;\n    border: 1px solid var(--SmartThemeBorderColor);\n    border-radius: var(--stwid-radius-s, 4px);\n    padding: 0.1em 0.35em;\n    font-size: 0.85em;\n    background-color: color-mix(in srgb, var(--SmartThemeBlurTintColor) 85%, black 10%);\n}\n\n.stwid--chipRemove {\n    background: none;\n    border: none;\n    padding: 0 0.1em;\n    cursor: pointer;\n    color: var(--SmartThemeQuoteColor);\n    line-height: 1;\n    font-size: 1em;\n}\n\n.stwid--chipRemove:hover {\n    color: var(--SmartThemeDangerColor, var(--SmartThemeQuoteColor));\n}`,
            },
            {
                name: 'Removable pill chip',
                html: `<span style="display:inline-flex;align-items:center;gap:0.35em;border:1px solid var(--SmartThemeBorderColor);border-radius:999px;padding:0.15em 0.65em 0.15em 0.45em;font-size:0.85em;background:color-mix(in srgb,var(--SmartThemeBlurTintColor) 85%,black 10%)"><button style="background:none;border:none;padding:0;cursor:pointer;color:var(--SmartThemeEmColor);line-height:1;font-size:1.1em;display:inline-flex;align-items:center;justify-content:center">×</button><span>Prose Inspiration</span></span>`,
        ...
        items: [
            {
                ...
                html: `<div style="position:relative;display:inline-flex;align-items:center;gap:0.35em"><button class="menu_button menu_button_icon" style="font-size:0.85em"><i class="fa-solid fa-eye"></i><span> Visibility</span><i class="fa-solid fa-caret-down" style="margin-left:2px"></i></button><div style="position:absolute;top:calc(100% + 0.35em);left:0;background:var(--SmartThemeBlurTintColor);backdrop-filter:blur(var(--blurStrength,4px));border:1px solid var(--SmartThemeBorderColor);border-radius:4px;padding:0.45em;display:flex;flex-direction:column;gap:0.3em;z-index:3;min-width:max-content;box-shadow:0 0 15px color-mix(in srgb,var(--SmartThemeBlurTintColor) 50%,transparent)"><button style="display:flex;align-items:center;gap:0.35em;font-size:1em;padding:2px 4px;border-radius:3px;border:0;color:var(--SmartThemeQuoteColor);background:transparent;cursor:pointer;text-align:left"><i class="fa-solid fa-square-check" style="width:1em;text-align:center;color:var(--SmartThemeQuoteColor)"></i> All Active</button><button style="display:flex;align-items:center;gap:0.35em;font-size:1em;padding:2px 4px;border-radius:3px;border:0;color:inherit;background:transparent;cursor:pointer;text-align:left"><i class="fa-regular fa-square" style="width:1em;text-align:center;color:var(--SmartThemeEmColor)"></i> Global</button><button style="display:flex;align-items:center;gap:0.35em;font-size:1em;padding:2px 4px;border-radius:3px;border:0;color:inherit;background:transparent;cursor:pointer;text-align:left"><i class="fa-regular fa-square" style="width:1em;text-align:center;color:var(--SmartThemeEmColor)"></i> Chat</button></div></div>`,
                css: `.stwid--multiselectDropdownWrap {\n    position: relative;\n    display: inline-flex;\n    align-items: center;\n    gap: 0.35em;\n}\n\n.stwid--multiselectDropdownButton {\n    display: inline-flex;\n    align-items: center;\n    gap: 0.25em;\n    padding: var(--stwid-hit-padding-y) var(--stwid-hit-padding-x);\n    border-radius: var(--stwid-radius-m);\n}\n\n.stwid--multiselectDropdownMenu {\n    position: absolute;\n    top: calc(100% + 0.35em);\n    left: 0;\n    background-color: color-mix(in srgb, var(--SmartThemeBlurTintColor) 90%, black 15%);\n    border: 1px solid var(--SmartThemeBorderColor);\n    border-radius: var(--stwid-radius-m);\n    padding: 0.45em;\n    display: none;\n    flex-direction: column;\n    gap: 0.3em;\n    z-index: 3;\n    min-width: max-content;\n}\n\n.stwid--multiselectDropdownMenu.stwid--active {\n    display: flex;\n    width: max-content;\n    background-color: var(--SmartThemeBlurTintColor);\n    backdrop-filter: blur(var(--blurStrength));\n    box-shadow: 0 0 15px color-mix(in srgb, var(--SmartThemeBlurTintColor) 50%, transparent);\n    border: 1px solid var(--SmartThemeBorderColor);\n    text-shadow: 0 0 calc(var(--shadowWidth) * 1px) var(--SmartThemeShadowColor);\n}\n\n.stwid--multiselectDropdownOption {\n    display: flex;\n    align-items: center;\n    gap: 0.35em;\n    font-size: 1em;\n    transition: color 150ms ease, background-color 150ms ease;\n    padding: 2px 4px;\n    border-radius: var(--stwid-radius-s);\n    border: 0;\n    color: inherit;\n    background: transparent;\n    cursor: pointer;\n    text-align: left;\n}\n\n.stwid--multiselectDropdownOption:hover {\n    color: var(--customThemeColor);\n    background-color: color-mix(in srgb, var(--customThemeColor) 20%, transparent);\n}\n\n.stwid--multiselectDropdownOption.stwid--active {\n    color: var(--SmartThemeQuoteColor);\n}\n\n.stwid--multiselectDropdownOptionIcon {\n    color: var(--customThemeColor);\n    display: inline-flex;\n    align-items: center;\n    justify-content: center;\n    line-height: 1;\n    width: 1em;\n}\n\n.stwid--multiselectDropdownOptionCheckbox {\n    width: 1em;\n    text-align: center;\n    color: var(--SmartThemeEmColor);\n}\n\n.stwid--multiselectDropdownOption.stwid--active .stwid--multiselectDropdownOptionCheckbox {\n    color: var(--SmartThemeQuoteColor);\n}`,
            },
            {
        ...
        items: [
            {
                ...
                html: `<div style="display:flex;align-items:center;gap:0.5em;border:1px solid var(--SmartThemeBorderColor);border-radius:4px;padding:0.35em 0.65em;position:relative;margin-top:0.75em"><span style="position:absolute;top:-0.6em;left:0.4em;font-size:0.7em;background:var(--SmartThemeBlurTintColor);padding:0 0.25em;color:var(--SmartThemeEmColor);line-height:1;white-space:nowrap">Depth</span><input type="number" class="text_pole" value="4" style="min-height:5px;padding:0 5px;font-size:0.95em;width:3.5em"><i class="fa-solid fa-fw fa-circle-question" style="padding-left:0.5em;opacity:0.6;cursor:pointer" title="Help tooltip"></i></div>`,
                css: `.stwid--bulkEditContainer {\n    display: flex;\n    align-items: center;\n    gap: 0.5em;\n    border: 1px solid var(--SmartThemeBorderColor);\n    border-radius: var(--stwid-radius-s, 4px);\n    padding: 0.35em 0.65em;\n    position: relative;\n}\n\n.stwid--bulkEditLabel {\n    position: absolute;\n    top: -0.6em;\n    left: 0.4em;\n    font-size: 0.7em;\n    background-color: var(--SmartThemeBlurTintColor);\n    padding: 0 0.25em;\n    color: var(--SmartThemeEmColor);\n    line-height: 1;\n    white-space: nowrap;\n}\n\ni.fa-solid.fa-fw.fa-circle-question.stwid--bulkEditLabelHint {\n    padding-left: 0.5em;\n}\n\n.stwid--bulkEditContainer.stwid--isDisabled {\n    opacity: var(--stwid-state-disabled-opacity, 0.4);\n    pointer-events: none;\n}`,
            },
            {
...
jQuery(async () => {
    ...
    document.addEventListener('click', (e) => {
        ...
        group.querySelectorAll('.csc--boxed-tab-btn').forEach(b => {
            const active = b.dataset.tab === tabId;
            b.style.background = active ? 'var(--SmartThemeBlurTintColor)' : 'transparent';
            b.style.border = active ? '1px solid var(--SmartThemeBorderColor)' : '1px solid transparent';
            b.style.borderBottom = active ? '1px solid var(--SmartThemeBlurTintColor)' : '1px solid transparent';
            b.style.opacity = active ? '1' : '0.55';
            b.style.zIndex = active ? '1' : '';
        });
