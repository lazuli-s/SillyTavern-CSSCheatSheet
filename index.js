        ...
        items: [
            {
                ...
                html: `<div style="display:flex;align-items:center;align-content:flex-start;gap:0.35em;flex-wrap:wrap"><span style="display:inline-flex;align-items:center;gap:0.25em;border:1px solid var(--SmartThemeBorderColor);border-radius:999px;padding:0.1em 0.45em;font-size:0.8em;background:color-mix(in srgb,var(--SmartThemeBlurTintColor) 85%,black 10%)"><i class="fa-solid fa-globe" style="color:var(--SmartThemeQuoteColor)"></i> Global</span><span style="display:inline-flex;align-items:center;gap:0.25em;border:1px solid var(--SmartThemeBorderColor);border-radius:999px;padding:0.1em 0.45em;font-size:0.8em;background:color-mix(in srgb,var(--SmartThemeBlurTintColor) 85%,black 10%)"><i class="fa-solid fa-comment" style="color:var(--SmartThemeQuoteColor)"></i> Chat</span></div>`,
