...
const CUSTOM_CSS = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                name: 'split-round-chip',
                html: `<span style="display:inline-flex;align-items:center;border:1px solid var(--SmartThemeBorderColor);border-radius:999px;overflow:hidden;font-size:0.8em;line-height:1;background:color-mix(in srgb,var(--SmartThemeBlurTintColor) 85%,black 10%)"><span style="display:inline-flex;align-items:center;justify-content:center;min-height:2em;padding:0 0.62em;white-space:nowrap;background:var(--SmartThemeQuoteColor);color:var(--white,#fff);font-weight:700">Global</span><span style="display:inline-flex;align-items:center;justify-content:center;min-height:2em;padding:0 0.62em;white-space:nowrap;border-left:1px solid color-mix(in srgb,var(--SmartThemeBorderColor) 70%,transparent);font-weight:600">text</span><button style="display:inline-flex;align-items:center;justify-content:center;min-height:2em;padding:0 0.62em;white-space:nowrap;border-left:1px solid color-mix(in srgb,var(--SmartThemeBorderColor) 70%,transparent);background:none;border:none;margin:0;color:var(--SmartThemeQuoteColor);cursor:pointer;line-height:1;font-size:0.9em"><i class="fa-solid fa-xmark"></i></button></span>`,
                css: `.split-round-chip {\n    display: inline-flex;\n    align-items: center;\n    border: 1px solid var(--SmartThemeBorderColor);\n    border-radius: 999px;\n    overflow: hidden;\n    font-size: 0.8em;\n    line-height: 1;\n    background-color: color-mix(in srgb, var(--SmartThemeBlurTintColor) 85%, black 10%);\n}\n\n.split-round-chip-category,\n.split-round-chip-label,\n.split-round-chip-remove {\n    display: inline-flex;\n    align-items: center;\n    justify-content: center;\n    min-height: 2em;\n    padding: 0 0.62em;\n    white-space: nowrap;\n}\n\n.split-round-chip-label,\n.split-round-chip-remove {\n    border-left: 1px solid color-mix(in srgb, var(--SmartThemeBorderColor) 70%, transparent);\n}\n\n.split-round-chip-category {\n    background-color: var(--SmartThemeQuoteColor);\n    color: var(--white, #fff);\n    font-weight: 700;\n}\n\n.split-round-chip-label {\n    font-weight: 600;\n}\n\n.split-round-chip-remove {\n    background: none;\n    border: none;\n    margin: 0;\n    color: var(--SmartThemeQuoteColor);\n    cursor: pointer;\n    line-height: 1;\n    font-size: 0.9em;\n}\n\n.split-round-chip-remove:hover {\n    color: color-mix(in srgb, var(--SmartThemeQuoteColor) 80%, var(--SmartThemeBodyColor) 20%);\n}`,
            },
            {
                name: 'filter-chip',
